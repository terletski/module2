...
//    if (command === 'add') addNotes();
//    else if (command === 'list') showListAllNotes();
//    else if (command === 'read') readOneNote(argv.title);
//    else if (command === 'remove') removeOneNote(argv.title);
...
//     function showListAllNotes(){
//         if (fs.existsSync('Notes.json', 'utf8')) {       
...
//         arrOfNotes = fs.readFileSync('Notes.json', 'utf8');
//         obj = JSON.parse(arrOfNotes);
//         if (title === argv.title) console.log(obj) 
//         }
